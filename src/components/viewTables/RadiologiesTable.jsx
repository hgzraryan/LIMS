...
import RadiologyPrint from "../views/RadiologyPrint";
function RadiologiesTable({
  ...
  dataReceived
   ...
   const handleOpenEditModal = (value) => {
    ...
    const handleRadiologysDetail = async (patientId) => {
    ...
    const columns = useMemo(
      () => [
        ...
        //   ),
          Cell: ({ row }) => (
            <>
              <div
                onClick={() => handleRadiologysDetail(row.original.radiologyId)}
                style={{ cursor: "pointer", textDecoration: "underline" }}
              >
                {row.original.radiologyId}
              </div>
            </>
          ),
        },
      ...
      [radiologies,setRadiologies,filterDataJSON,filterData]
    );
...
export default RadiologiesTable;