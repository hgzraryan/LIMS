...
const Users = () => {
    ...
    const [showUserMenu, setIsActiveUsers] = useState(false);
    const ShowUsers = event => {
        setIsActiveUsers(current => !current);
    };
    //-------------------
                                 ...
                                 <header className="contact-header">
                                     <div className="d-flex align-items-center">
                                         <div className="dropdown">
                                             <a className="contactapp-title dropdown-toggle link-dark" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" onClick={ShowUsers}>
                                                 <h1>Աշխատակիցներ</h1>
                                             </a>
                                         ...
                                         <div className="dropdown ms-3">
                                             <button className="btn btn-sm btn-outline-secondary flex-shrink-0 dropdown-toggle d-lg-inline-block d-none" data-bs-toggle="dropdown" onClick={CreateNew}>Create New</button>
