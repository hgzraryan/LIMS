...
const REGISTER_URL = "/organizations";
...
const Organizations = () => {
  ...
  const currentPrices = organizations.slice(pagesVisited, pagesVisited + usersPerPage);
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="dropdown ms-3">
					 <Dropdown>
					  ...
					  <Dropdown.Menu>
						<Dropdown.Item onClick={() => setIsOpen(true)}>Կազմակերպություն</Dropdown.Item>
