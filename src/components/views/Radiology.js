...
import RadiologiesTable from "../viewTables/RadiologiesTable";
import AddRadiology from "../addViews/AddRadiology";
...
function Radiology() {
  ...
  return (
    <HelmetProvider>    
       <Helmet>
      <meta charSet="utf-8" />
      <title>Vteam LIMS | Radiology</title>
