...
function AgentsInfoModal({setModalInfo,modalInfo}) {
  return (
    <Modal
      show={() => true}
      size="md"
            ...
            <div data-simplebar className="nicescroll-bar">
              <div className="d-flex flex-xxl-nowrap flex-wrap">
                <div className="contact-info w-100">
                  ...
                  <div className="w-100">
                       <div className="d-flex justify-content-between">  <span>ID </span> <span>{modalInfo.agentId}</span></div>
                     ...
                     <div className="separator-full m-0"></div>
                       ...
                       <div className="separator-full m-0"></div> 
                       <div className="d-flex justify-content-between">  <span>Հ/Հ</span> <span>{modalInfo?.bankAccNumber}</span></div>
                       <div className="separator-full m-0"></div>                  
