       ...
       <div className='wrapper'>
          <header className='header'>
            <div className='container' style={{display:'flex',justifyContent:'space-between', marginTop:'20px'}}>
              <div header__logo style={{display:'flex'}} >
                <img width={'120px'} src='./../dist/img/avatar1.jpg' alt='Logo' style={{marginRight:'10px'}}/>
                <div>
                  <h1>Prom-test</h1>
                  <h4>Laboratories</h4>
                </div>
          ...
          <main>
            <article className='container'>
              <div className='Requisites' style={{display:'flex', flexDirection:'column', alignItems:'center',justifyContent:'center'}}>
                  <p>Prom-test</p>
                  <p>hvhh12457888</p>
            ...
            <article className='container' >
              <div className='qr-code' style={{display:'flex', justifyContent:'space-between', marginBottom:'20px'}}>
