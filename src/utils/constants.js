...
export const DOCTORS_ROUTE = 'doctors/list'
export const DOCTORS_ID_ROUTE = 'doctors/:id'
export const DOCTORS_EMPLOYMENT_ROUTE = 'doctors/employment'
export const REFDOCTORS_ROUTE = 'doctors/refDoctors'
export const DOCTORSVISITS_ROUTE = 'doctorsVisits'
...
export const MEDINSTITUTIONS_ROUTE = 'medInstitutions'
...
export const REAGENTS_ROUTE = 'setup/reagents'
export const EQUIPMENTS_ROUTE = 'setup/equipments'
export const RESEARCH_LISTS_ROUTE = 'setup/researchlists'
export const MEDICALSERVICES_ROUTE = 'setup/medicalServices'
